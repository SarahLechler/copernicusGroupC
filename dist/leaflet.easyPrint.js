...
options: {
    ...
    onAdd: function () {
        ...
        this.link.sizeModes = this.options.sizeModes;
...
setTimeout(
        function () {
            ...
            var zoomControls = document.getElementsByClassName("leaflet-right")[0];
            console.log(zoomControls);
            zoomControls.className += " hideInPrint";
        },
        1000);
